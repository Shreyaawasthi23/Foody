  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          className="w-full cursor-pointer mt-6 flex items-center 
              justify-center gap-2 border-lg px-4 py-2 transition duration-200 border-gray-400 hover:bg-gray-200"
