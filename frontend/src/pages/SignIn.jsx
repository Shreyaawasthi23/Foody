        ...
        <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px]`} style={{
            ...
            <p className='text-gray-600 mb-8'>Sign In to your account to get started with delicious food deliveries</p>
             ...
             <div className='mb-4'>
                ...
                <button className='absolute curser-pointer right-3 top-[14px] text-gray-500' 
                onClick={() => setShowPassword(prev=>!prev)} >{!showPassword?<FaRegEye/>: <FaEyeSlash/>}</button>
                </div>
             ...
             <div className='text-right mb-4 text-[#ff4d2d] font-medium cursor-pointer' onClick={()=>navigate("/forgot-password")}>
              ...
              <button className='w-full cursor-pointer mt-6 flex items-center justify-center gap-2
               border-lg px-4 py-2 transition duration-200 border-gray-400 hover:bg-gray-200' onClick={handleGoogleAuth}>
                <FcGoogle size={20}/>
                <span>Sign In with Google</span>
              </button>
              <p className='text-center mt-2 cursor-pointer' onClick={()=> navigate("/signup")}> Don't have Account ? Click Here to <span className='text-[#ff4d2d]'>Sign Up</span> </p>
        </div>
